...
function prngAddEntropy(ent, quality) {
   if (prngBitsCollected < 256) {
      ...
      if (prngBitsCollected >= 256) {
        console.log("Churning greater than 256 bits");
         prngChurn();
      }
   } else {
      prngEntropyString += ent;
      if (prngEntropyString.length >= 4096) {
        console.log("Churning long string");
         prngChurn();
      }
   }
}
...
function prngChurn() {
  console.log("Bits collected: " + prngBitsCollected);
  console.log("Entropy String: " + prngEntropyString);
  console.log("Available bits: " + prngAvailableBits);
  console.log("PRNG Binary: " + prngBinary);
